                            ...
                            <div className="blog_category">
                                ...
                                <div className="wrap_set">
                                    <strong className="tit_set">
                                        ...
                                        <a href="http://notice.tistory.com/601" className="info_sub" target="_blank">
                                            자세히 보기
                                        </a>
                                    </strong>
                                    ...
                                    <div className="bundle_group">
                                      <span className="count_total">
                                        ...
                                        <label className="lab_btn btn_group">
                                            전체 펼치기
                                            <input type="button" className="btn_g" defaultValue="카테고리 전체 펼치기"/>
                                        </label>
                                        <label className="lab_btn btn_group">
                                            전체 접기
                                            <input type="button" className="btn_g" defaultValue="카테고리 전체 접기"/>
                                        </label>
                                    </div>
                                                ...
                                                <div className="bundle_item open_subcate">
                                                    <div className="item_order">
                                                        <label className="lab_btn lab_cate">
                                                            ...
                                                            <input type="button" className="btn_g" defaultValue="open sub category"/>
                                                        </label>
                                                        <div className="basic_item">
                                                            ...
                                                            <div style={{display: "inline"}}>
                                                                <div className="wrap_name">
                                                                    <span
                                                                        className="txt_name">Spring Boot &amp; JPA</span>
